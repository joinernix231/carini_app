...
const validationSchema = Yup.object().shape({
    ...
    document: Yup.string().trim().required('Documento es requerido'),
...
export default function TecnicoForm({ initialValues, onSubmit, submitLabel = 'Guardar técnico' }: Props) {
    return (
        <Formik
                ...
                <>
                    <View style={styles.card}>
                        ...
                        <TextInput
                            ...
                            onBlur={() => formik.setFieldTouched('document')}
                        />
                        {formik.touched.document && formik.errors.document && (
                            <Text style={styles.errorText}>{formik.errors.document}</Text>
                        )}
