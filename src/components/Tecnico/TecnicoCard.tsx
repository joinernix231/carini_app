...
function TecnicoCardComponent({ item, onPress, onDelete }: Props) {
    ...
    return (
        <TouchableOpacity
            ...
            accessibilityLabel={`Ver técnico ${item.user?.name || item.name}`}
            style={styles.card}
        >
            ...
            <View style={styles.headerSection}>
                ...
                <View style={styles.nameSection}>
                    <Text style={styles.tecnicoName} numberOfLines={1}>
                        {item.user?.name || item.name || 'Técnico sin nombre'}
                    </Text>
                    ...
                    <View style={styles.statusContainer}>
                        ...
                        <View style={styles.roleBadge}>
                            <Ionicons name="build-outline" size={12} color="#DC2626" />
            ...
            <View style={styles.actionsSection}>
                <TouchableOpacity
                    onPress={() => onDelete(item.id, item.user?.name || item.name || 'Técnico')}
                    style={styles.actionButton}
                    accessibilityLabel={`Eliminar técnico ${item.user?.name || item.name}`}
                    accessibilityRole="button"
                >
...
export default React.memo(TecnicoCardComponent, (prev, next) =>
